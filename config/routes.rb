Jewelly::Application.routes.draw do
  resources :wastages do as_routes end

  resources :confs do as_routes end

  resources :diamonds do as_routes end

  resources :stones do as_routes end
